...
public class ContactActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((ListView)findViewById(R.id.contactList)).setOnItemClickListener(
				new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> v, View arg1,
						...
						final EditText coursename = new EditText(v.getContext());
						final EditText coursenum = new EditText(v.getContext());
						final Course course = contact.getCourses().get(pos);
						coursename.setHint("Course Name");
						coursenum.setHint("CN");

						LinearLayout ll= new LinearLayout(v.getContext());
						ll.setOrientation(LinearLayout.VERTICAL);
						ll.addView(coursename);
						ll.addView(coursenum);

						AlertDialog.Builder alert = new AlertDialog.Builder(v.getContext())
						.setTitle("Edit the course:")
						.setView(ll);//        .show()
						...
						alert.setPositiveButton("Save", new DialogInterface.OnClickListener() { 
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								course.setCoursenum(coursename.getText().toString());
	...
	public void updateCourseList(){
		courselist.clear();
		ArrayList<Course> courses = parser.getContactInfo().getCourses();
